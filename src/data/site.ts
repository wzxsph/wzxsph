  ...
  en: [
    {
      ...
      summary:
        "A six-stage editorial workspace from garment facts and source media to reviewed outputs and a manifest-backed ZIP.",
      proof: ["Six explicit workflow stages", "Quality evidence + human selection", "Original demo pack + manifest ZIP"],
      links: [
        { label: "Live Mock v7", href: "https://fashionai-studio-demo.pages.dev/#/showcase" },
  ...
  zh: [
    {
      ...
      title: "FashionAI Studio",
      category: "人工审核式生成媒体",
      summary: "六阶段编辑工作台，把商品事实与源素材变成可审核结果和带 manifest 的 ZIP。",
      proof: ["六个明确工作阶段", "质量证据与人工选择分离", "原创样例与 manifest ZIP"],
      links: [
        { label: "在线 Mock v7", href: "https://fashionai-studio-demo.pages.dev/#/showcase" },
